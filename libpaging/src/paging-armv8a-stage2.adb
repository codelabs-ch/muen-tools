   ...
   is
      ...
      begin
         Raw_Table (Index) := Create_Entry
           (Address        => Entries.Get_Dst_Address (E => TEntry),
            Present        => Entries.Is_Present (E => TEntry),
            Readable       => Entries.Is_Readable (E => TEntry),
            Writable       => Entries.Is_Writable (E => TEntry),
            Executable     => Entries.Is_Executable (E => TEntry),
            Not_Large_Page => not Entries.Maps_Page (E => TEntry),
            Accessed       => Entries.Maps_Page (E => TEntry),
            Memory_Type    => Entries.Get_Caching (E => TEntry));
