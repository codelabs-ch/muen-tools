...
--  placed into DTS.Generator.Test_Data.
...
--  begin read only
--  end read only
package body DTS.Generator.Test_Data.Tests is
...
--  end read only
   ...
   begin
      ...
      Assert (Condition => Test_Utils.Equal_Files
              ...
              Message   => "DTS mismatch for Linux 1 (full test policy)");
      Assert (Condition => Test_Utils.Equal_Files
              (Filename1 => "data/dts_full_lnx2.ref",
               Filename2 => "obj/devicetree_lnx2.dts"),
              Message   => "DTS mismatch for Linux 2 (full test policy)");
...
--  begin read only
--  end read only
end DTS.Generator.Test_Data.Tests;
